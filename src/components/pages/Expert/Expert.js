        ...
        <Row>
          ...
          <Col lg={3} md={3} sm={6}>
            <div className="benefit-div p-3 m-3 text-center">
              <img src={require('../../asset/expert/e (2).png')} className='exp-img' alt="" />
              <hr></hr>
              <div className='d-flex justify-content-between'>
                <div>
                  <h6>LORA SNOW</h6>
          ...
          <Col lg={3} md={3} sm={6}>
            <div className="benefit-div p-3 m-3 text-center">
              <img src={require('../../asset/expert/e (3).png')} className='exp-img' alt="" />
              <hr></hr>
              <div className='d-flex justify-content-between'>
                <div>
                  <h6>LORA SNOW</h6>
          ...
          <Col lg={3} md={3} sm={6}>
            <div className="benefit-div p-3 m-3 text-center">
              <img src={require('../../asset/expert/e (1).png')} className='exp-img' alt="" />
              <hr></hr>
              <div className='d-flex justify-content-between'>
                <div>
                  <h6>LORA SNOW</h6>
          ...
          <Col lg={3} md={3} sm={6}>
            <div className="benefit-div p-3 m-3 text-center">
              <img src={require('../../asset/expert/e (4).png')} className='exp-img' alt="" />
              <hr></hr>
              <div className='d-flex justify-content-between'>
                <div>
                  <h6>LORA SNOW</h6>
          ...
          <Col lg={3} md={3} sm={6}>
            <div className="benefit-div p-3 m-3 text-center">
              <img src={require('../../asset/expert/e (5).png')} className='exp-img' alt="" />
              <hr></hr>
              <div className='d-flex justify-content-between'>
                <div>
                  <h6>LORA SNOW</h6>
          ...
          <Col lg={3} md={3} sm={6}>
            <div className="benefit-div p-3 m-3 text-center">
              <img src={require('../../asset/expert/e (6).png')} className='exp-img' alt="" />
              <hr></hr>
              <div className='d-flex justify-content-between'>
                <div>
                  <h6>LORA SNOW</h6>
